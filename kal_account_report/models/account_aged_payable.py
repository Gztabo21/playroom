...
class AccountAgedPayableInherit(models.AbstractModel):
    ...
    def _get_column_details(self, options):
        res = super(AccountAgedPayableInherit,self)._get_column_details(options)
        res.insert(1,self._field_column('reference'))
        return res
