...
class IrSequenceDianResolution(models.Model):
    ...
    number_next = fields.Integer(
        "Next Number", compute="_get_initial_number", store=True
    )
    ...
    active_resolution = fields.Boolean(
        "Active resolution", required=False, default=False
    )
