...
class ResCompany(models.Model):
    ...
    text_amount_language_currency = fields.Selection(
        [
            ("en", "English"),
            ("ar", "Arabic"),
            ("cz ", "Czech"),
...
class AccountConfigSettings(models.TransientModel):
    ...
    text_amount_language_currency = fields.Selection(
        related="company_id.text_amount_language_currency",
    ...
    def save_text_amount_language_currency(self):
        if self.text_amount_language_currency:
            self.company_id.text_amount_language_currency = (
                self.text_amount_language_currency
            )
