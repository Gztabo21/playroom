odoo.define('l10n_cl_pos_fe.models', function (require) {
    ...
    models.load_models({
      model: 'pos.order',
      fields: ['id', 'name', 'account_move', 'pos_reference','date_order', 'l10n_latam_document_number','note', 'signature', 'l10n_latam_document_type_id_code',
               'to_ticket', 'to_invoice', 'partner_id', 'amount_total', 'session_id', 'user_id', 'lines', 'amount_tax'],
      loaded: function (self, pos_orders) {
          self.posOrders = pos_orders;
      },
    ...
    models.load_fields('account.move', ['name','l10n_latam_document_number']);
    ...
    models.PosModel = models.PosModel.extend({
        ...
        return this._save_to_server(orders, options).then(function (server_ids) {
            ...
            for (let i = 0; i < server_ids.length; i++) {
                ...
                self.validated_orders_name_server_id_map['account_move'] = server_ids[i].account_move;
            }
    ...
    var _super_order = models.Order.prototype;
      ...
      export_as_JSON: function () {
        ...
        json.account_move = this.account_move
